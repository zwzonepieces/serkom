...
<div class="jumbotron jumbotron-fluid bg-dark my-2 mx-4">
    ...
    <div class="container text-white">
        ...
        <p class="lead">Selamat datang di sistem pengaduan jaringan wifi ZTE, silahkan adukan permasalahan jaringan anda kepada kami.</p>
        <hr class="my-4">
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; SerkomBSI <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
